const PILLARS = [
  { icon: "🎯", label: "Mission", color: "from-blue-500 to-cyan-400", glow: "rgba(79,110,247,0.15)", text: "Bridge the gap between academic knowledge and industry — through hands-on training, internships, and live projects." },
  { icon: "🔭", label: "Vision", color: "from-violet-500 to-purple-400", glow: "rgba(139,92,246,0.15)", text: "Create skilled professionals ready for the future of technology, equipped to lead the next wave of innovation." },
  { icon: "💎", label: "Values", color: "from-pink-500 to-rose-400", glow: "rgba(236,72,153,0.15)", text: "Practical learning, transparent mentorship, accountability for outcomes, and respect for every student's journey." },
  { icon: "⚙️", label: "Approach", color: "from-emerald-500 to-teal-400", glow: "rgba(16,185,129,0.15)", text: "Project-first curriculum, working-professional mentors, and continuous feedback loops grounded in real industry needs." },
];
    ...
    <section id="about" className="py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 max-w-6xl relative z-10">
        ...
        <div className="mb-14 text-center">
          ...
          <p className="text-white/80 text-base font-medium leading-relaxed border-l-2 border-cyan-400 pl-4 italic max-w-xl mx-auto text-left">
        ...
        <div className="mb-6 text-center">
          ...
          <p className="text-gray-600 text-sm mt-1">Mission, vision, and the way we work.</p>
        </div>
